...
public class Shili {
	...
	public static void main(String[] args) throws Exception {
		//读取源文件并将数据写入双列集合
		FileInputStream shilishuju_source = new FileInputStream("E:\\2019下学期\\Java基础入门\\1120\\shili.xlsx");
		...
		//读取目标文件并将数据写入目标文件
		FileInputStream shilishuju_dest = new FileInputStream("E:\\2019下学期\\Java基础入门\\1120\\18rj2.xlsx");
		@SuppressWarnings("resource")
		...
		for (int i = 1; i <= rows_dest; i++) {
			...
			List<Object> list_dest = (List<Object>)map.get(xuehao);
			System.out.println(list_dest);
			if (list_dest!=null) {
				
				rowi_dest.createCell(15, CellType.STRING).setCellValue(list_dest.get(11).toString());
				rowi_dest.createCell(16, CellType.STRING).setCellValue(list_dest.get(11).toString());
			}
			
			}
		
		FileOutputStream shilishujushuchu_dest = new FileOutputStream("E:\\\\2019下学期\\\\Java基础入门\\\\1120\\\\18rj2.xlsx");
